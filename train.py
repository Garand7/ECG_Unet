...
def make_args():
    ...
    parser.add_argument('--val_freq', type=int, default=10, help='architecture name')
...
class Trainer:
    ...
    def build_model(self):
        self.model = unet_s(1, 3).to(device)
    ...
    def train(self):
        for epoch in range(self.args.n_epoch):
            ...
            if (epoch+1)%self.args.save_freq==0:
                torch.save(self.model.state_dict(), os.path.join(self.args.save_dir, f'{epoch}.pth'))
